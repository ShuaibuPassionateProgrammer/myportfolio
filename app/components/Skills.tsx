  ...
  return (
    <section id="skills" className="space-y-16">
            ...
            <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-slate-200 dark:border-slate-700 h-full">
              ...
              <div className="flex flex-wrap gap-2">
                {category.skills.map((skill, i) => (
                  <span
                    key={i}
                    className="bg-slate-100/80 dark:bg-slate-700/80 text-slate-700 dark:text-slate-300 px-3 py-1 text-sm rounded-lg hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors duration-200"
                  >
                    {skill}
                  </span>
                ))}
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl p-8 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700"
      >
